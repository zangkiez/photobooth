...
var photoBooth = (function () {
    ...
    api.thrill = /*#__PURE__*/ (function () {
        var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regenerator().m(function _callee(photoStyle) {
                var retry,
                    countdownTime,
                    maxGetMediaRetry,
                    getMode,
                    ...
                    while (1)
                        switch (_context.n) {
                            ...
                            case 2:
                                ...
                                _t = api.photoStyle;
                                _context.n =
                                    _t === PhotoStyle.COLLAGE
                                        ? 3
                                        : _t === PhotoStyle.VIDEO
                                          ? 4
                                          : _t === PhotoStyle.CUSTOM
                                            ? 5
                                            : _t === PhotoStyle.PHOTO
                                              ? 6
                                              : 6;
                            ...
                            case 7:
                                ...
                                _t2 = api.photoStyle;
                                _context.n =
                                    _t2 === PhotoStyle.COLLAGE
                                        ? 8
                                        : _t2 === PhotoStyle.VIDEO
                                          ? 9
                                          : _t2 === PhotoStyle.CUSTOM
                                            ? 10
                                            : _t2 === PhotoStyle.PHOTO
                                              ? 11
                                              : 11;
                                break;
                            case 8:
                                    ...
                                    .done(
                                        /*#__PURE__*/ (function () {
                                            var _ref3 = _asyncToGenerator(
                                                /*#__PURE__*/ _regenerator().m(function _callee2(result) {
                                                    var imageUrl,
                                                        preloadImage,
                                                        picdate,
                                                        takePictureButton,
                                                        collageProcessButton,
                                                        retakeButton,
                                                        abortButton;
                                                        ...
                                                        while (1)
                                                            switch (_context2.n) {
                                                                ...
                                                                case 2:
                                                                    ...
                                                                    $(
                                                                        '.sidenav-list-item[data-filter="' +
                                                                            imgFilter +
                                                                            '"]'
                                                                    ).addClass('sidenav-list-item--active');
                                                                    previewFrameCollage.hide();
                                                                    previewFramePicture.hide();
                                                                    if (result.error) {
                                                                        photoboothTools.console.logDev(
                                                                        ...
                                                                        if (config.collage.continuous) {
                                                                            loaderMessage.append(
                                                                                $('<p>').text(
                                                                                    photoboothTools.getTranslation(
                                                                                        'wait_message'
                                                                                    )
                                                                                )
                                                                            );
                                                                            ...
                                                                            retakeButton = $(
                                                                                '<button type="button" class="button collageRetake rotaryfocus">'
                                                                            );
                                                                            retakeButton.append(
                                                                                '<span class="button--icon"><i class="' +
                                                                            ...
                                                                            abortButton = $(
                                                                                '<button type="button" class="button collageAbort rotaryfocus">'
                                                                            );
                                                                            abortButton.append(
                                                                                '<span class="button--icon"><i class="' +
                                                                                    config.icons['delete'] +
                                    ...
                                    .fail(
                                        /*#__PURE__*/ (function () {
                                            var _ref4 = _asyncToGenerator(
                                                /*#__PURE__*/ _regenerator().m(function _callee3(xhr, status, result) {
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            result = {
                                                                                error:
                                                                                    result ||
                                                                                    'Unexpected error: result is null or undefined'
                                                                            };
                                                                        ...
                                                                        photoboothTools.console.log(
                                                                            'Unexpected error in .fail block',
                                                                            error
                                                                        );
                                                                        api.errorPic({
                                                                            error:
                                                                                error.message ||
                                                                                'An unexpected error occurred during failure handling'
                                                                        });
                                                                    }
                                                                case 1:
            ...
            .done(
                /*#__PURE__*/ (function () {
                    var _ref5 = _asyncToGenerator(
                        /*#__PURE__*/ _regenerator().m(function _callee5(result) {
                                ...
                                while (1)
                                    switch (_context5.n) {
                                        case 0:
                                            ...
                                            $('.sidenav-list-item[data-filter="' + imgFilter + '"]').addClass(
                                                'sidenav-list-item--active'
                                            );
                                            if (result.error) {
                                                api.errorPic(result);
    ...
    api.showMailForm = function (image) {
        ...
        // Submit
        var submitLabel = config.mail.send_all_later
    ...
    api.renderPic = function (filename, files) {
        ...
        buttonPrint.off('click').on(
            'click',
            /*#__PURE__*/ (function () {
                var _ref6 = _asyncToGenerator(
                    /*#__PURE__*/ _regenerator().m(function _callee6(event) {
                        var copies, _t3;
            ...
            .on(
                ...
                /*#__PURE__*/ (function () {
                    var _ref7 = _asyncToGenerator(
                        /*#__PURE__*/ _regenerator().m(function _callee7(ev) {
                            var really, _t4;
                            return _regenerator().w(function (_context7) {
                                while (1)
                                    switch (_context7.n) {
                                        ...
                                        case 1:
                                            _context7.n = 2;
                                            return photoboothTools.confirm(
    ...
    api.addVideoToGallery = function (videoName) {
        ...
        var linkEl = $('<a>')
            ...
            .attr('href', videoUrl)
            .attr('data-pswp-type', 'video-slide')
            .attr('data-video-src', videoUrl)
            .attr('data-video-poster', posterUrl)

...
var photoboothPreviewTest = function () {
  ...
  buttonStartPreview.on('click', function (event) {
  ...
  buttonStopPreview.on('click', function (event) {
    event.preventDefault();
  ...
  buttonShowFramePicture.on('click', function (event) {
    event.preventDefault();
  ...
  buttonShowFrameCollage.on('click', function (event) {
    event.preventDefault();
  ...
  buttonHideFrame.on('click', function (event) {
    event.preventDefault();
  ...
  previewVideo.on('loadedmetadata', function (event) {

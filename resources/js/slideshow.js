...
var ssTimeOut,
    ssRunning = false,
    lastDBSize = -1;
var ssDelay = config.slideshow.pictureTime,
...
$(function () {
    ...
    /* Use same gallery markup as main app: show refresh, bind close to go back */
    var $refresh = $('.gallery__refresh');
    var $close = $('.gallery__close');

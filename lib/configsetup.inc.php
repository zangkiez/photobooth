...
return [
    ...
    'collage' => [
        ...
        'collage_background_on_top' => [
            'view' => 'expert',
            'type' => 'checkbox',
            'name' => 'collage[background_on_top]',
            'data-theme-field' => 'true',
            'value' => $config['collage']['background_on_top'] ?? false,
        ],
        'collage_background_overlay_opacity' => [
            'view' => 'expert',
            'type' => 'range',
            'name' => 'collage[background_overlay_opacity]',
            'data-theme-field' => 'true',
            'placeholder' => $defaultConfig['collage']['background_overlay_opacity'] ?? 100,
            'value' => (int) ($config['collage']['background_overlay_opacity'] ?? 100),
            'range_min' => 0,
            'range_max' => 100,
            'range_step' => 5,
            'unit' => 'percent',
